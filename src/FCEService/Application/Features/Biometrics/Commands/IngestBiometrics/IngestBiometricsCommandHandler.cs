...
public class BiometricsCommandHandler(ILogger<IngestBiometricsCommand> logger, IAppDbContext context)
    : IRequestHandler<IngestBiometricsCommand, Result<Success>>
{
